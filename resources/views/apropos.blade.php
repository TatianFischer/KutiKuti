	...
	<div class="row">
		<div class="col-md-12 desc1">
			<div class="col-md-4 paragraphe">
				<p id="apropos_paragraphe">Kutì Kutì est un jeu d'assemblage lumineux et interactif. Par le montage de volumes abstraits et de circuits éléctroniques simples, les enfants définissent la création de formes animales imaginaires</p>
			</div>
			<div class="col-md-4">
